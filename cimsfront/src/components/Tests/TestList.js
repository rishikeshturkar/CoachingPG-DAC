...
class TestList extends Component{
    ...
    addTest=()=>{
        ...
        this.props.history.push("/Admin/Tests/add/_add")
    }
    editTest=(empid)=>{
        console.log("in emplist edit emp");
        // let history=useHistory();
        this.props.history.push(`/Admin/Tests/add/${empid}`)
    }
    deleteTest=(empid)=>{
                          ...
                          this.state.searcharr.map((emp)=>
                            <tr key={emp.testId}>
                                ...
                                <td>
                                    ...
                                    <Link to={`/Admin/Tests/view/${emp.testId}`}><button className="btn btn-success">VIEW</button></Link>
                                </td>
