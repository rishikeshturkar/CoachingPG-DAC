...
class TestDetailsForFaculty extends Component{
    constructor(props){
        super(props);
...
handleFormSubmit(ev) {
    ...
    <Link to="/Faculty"><button type="button" className="btn btn btn-primary">BACK</button></Link> 
        </Form>
    </div>
        );
    }
...
export default withRouter(TestDetailsForFaculty);